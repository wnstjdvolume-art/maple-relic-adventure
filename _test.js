...
const noop = () => {};
function fakeEl() {
  return { style: {}, classList: { add: noop, remove: noop }, set textContent(v) {},
...
`;
const ctx = { document, window: {}, addEventListener: noop, requestAnimationFrame: noop, console, Math, Date, JSON };
ctx.globalThis = ctx;
...
if (b1boss) {
  ...
  b.enemy.hp = 1; b.menuIndex = 0; api.handleBattleKey("enter"); clearMsgs();
